...
L5M5inMD.allowed_values = [
    ...
    # <MDs3^7_L5M5, base_pc=D>,
    # <MDs4^1_L5M5, base_pc=G>,
    # <MDs5^2_L5M5, base_pc=G>,
    # <MDs♭6^3_L5M5, base_pc=D>,
    # <MDs6^3_L5M5, base_pc=E>,
    # <MDs7^4_L5M5, base_pc=B>,
    # <MDs1^5_L5M5, base_pc=D>,
    # <MDs2^6_L5M5, base_pc=E>,
    # <MDs♭3^7_L5M5, base_pc=G>,
    # <MDs3^7_L5M5, base_pc=E>,
    # <MDs♭4^1_L5M5, base_pc=F>,
    # <MDs4^1_L5M5, base_pc=D>,
    # <MDs♭5^2_L5M5, base_pc=E>,
    # <MDs5^2_L5M5, base_pc=D>,
    # <MDs♭6^3_L5M5, base_pc=D>,
    # <MDs6^3_L5M5, base_pc=F>,
    # <MDs7^4_L5M5, base_pc=D>,
]
...
L4M4inMD.allowed_values = [
    ...
    L4M4inMD(bottom_md=ModeDegree(value=3, alter=-1), top_md=ModeDegree(value=6, alter=-1)),
    ...
    #  <MDs2^♭5_L4M4, base_pc=E>,
    #  <MDs2^5_L4M4, base_pc=D>,
    #  <MDs♭3^♭6_L4M4, base_pc=G>,
    #  <MDs3^6_L4M4, base_pc=C>,
    #  <MDs3^♭6_L4M4, base_pc=D>,
    #  <MDs♭4^♭7_L4M4, base_pc=F>,
    #  <MDs4^♭7_L4M4, base_pc=C>,
    #  <MDs4^7_L4M4, base_pc=D>,
    #  <MDs5^1_L4M4, base_pc=D>,
    #  <MDs6^2_L4M4, base_pc=E>,
    #  <MDs7^♭3_L4M4, base_pc=G>,
    #  <MDs7^3_L4M4, base_pc=D>,
]
