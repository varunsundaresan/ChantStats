...
def test_modal_category_type():
    ...
    assert t.get_output_path_stub_2("A") == "1.final_5.A"
    ...
    assert t.get_output_path_stub_2(("B-", "plagal")) == "3.plagal_6.B-"
    ...
    assert t.get_output_path_stub_2(("C", "authentic")) == "2.authentic_8.C"
