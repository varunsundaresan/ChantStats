...
def test_modal_category_type():
    ...
    assert t.get_output_path_stub_2("A") == "07.A_1.final"
    ...
    assert t.get_output_path_stub_2(("B-", "plagal")) == "08.B-_3.plagal"
    ...
    assert t.get_output_path_stub_2(("C", "authentic")) == "10.C_2.authentic"
...
def test_make_results_dataframe():
    ...
    row_piece1 = pd.Series([40.0, 0, 20.0, 0, 0, 0, 20.0, 0, 0, 20.0], index=list(PC))
    row_piece2 = pd.Series([0, 0, 0, 37.5, 0, 12.5, 12.5, 12.5, 12.5, 12.5], index=list(PC))
    row_piece3 = pd.Series([0, 0, 0, 20.0, 0, 20.0, 40.0, 0, 0, 20.0], index=list(PC))
