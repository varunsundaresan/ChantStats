...
pieces_1_thru_8 = load_plainchant_sequence_pieces(chants_dir, pattern="0[1-8]*.xml")
...
piece32 = PlainchantSequencePiece(os.path.join(chants_dir, "32_Magnus_deus.xml"))             # heavy polymodal frame 2 (with amen formula)
